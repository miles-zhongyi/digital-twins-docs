...
**Near-term goal:** <span class="glossary-term" data-glossary-id="ue" data-glossary-term="UE" data-glossary-definition="User Equipment — the mobile device (phone/modem) that attaches to the cellular network." tabindex="0" role="button">UE</span> emulator + basic RU interface toward OSC O-CU/DU.
...
| Scenario | Purpose |
|---|---|
| **1 — Scale traffic** | Generate realistic UE mobility/RF toward <span class="glossary-term" data-glossary-id="du" data-glossary-term="DU" data-glossary-definition="Distributed Unit — runs lower real-time layers (RLC, MAC, high-PHY scheduling) in an O-RAN split. A software DU runs on general-purpose servers; non-real-time simulation DUs can be time-dilated, real-time DUs driving real fronthaul cannot." tabindex="0" role="button">DU</span>/CU at cluster scale |
| **2 — Fake RU** | Let DU/<span class="glossary-term" data-glossary-id="cu" data-glossary-term="CU" data-glossary-definition="Centralized Unit — higher layers (PDCP/RRC) in a split base station, less time-critical than the DU. Connects to DU over F1." tabindex="0" role="button">CU</span> teams validate config changes against an emulated RU |
...
| Multi-<span class="glossary-term" data-glossary-id="ue" data-glossary-term="UE" data-glossary-definition="User Equipment — the mobile device (phone/modem) that attaches to the cellular network." tabindex="0" role="button">UE</span> handover | Yes | Single UE | Yes |
...
over an unreliable channel (unlike SCTP-backed <span class="glossary-term" data-glossary-id="nas" data-glossary-term="NAS" data-glossary-definition="Non-Access Stratum — Layer 3 protocol between UE and core for attach, authentication, and session management." tabindex="0" role="button">NAS</span>), and depends on <span class="glossary-term" data-glossary-id="harq" data-glossary-term="HARQ" data-glossary-definition="Hybrid Automatic Repeat Request — L1/L2 retransmission mechanism whose timing RRC procedures depend on." tabindex="0" role="button">HARQ</span>/ARQ
...
| Radio link failure | T310 expiry | <span class="glossary-term" data-glossary-id="rrc" data-glossary-term="RRC" data-glossary-definition="Radio Resource Control — Layer 3 protocol between UE and base station for connection setup, mobility, and bearer configuration." tabindex="0" role="button">RRC</span> release → re-registration |
...
| **B — <span class="glossary-term" data-glossary-id="ecpri" data-glossary-term="eCPRI" data-glossary-definition="Enhanced Common Public Radio Interface — a protocol that packages IQ samples into standard ethernet frames for efficient transport on fiber between RU and DU." tabindex="0" role="button">eCPRI</span> + synthetic IQ** | Correct framing, statistical IQ content | **Recommended** — catches fronthaul issues |
...
|---|---|---|
| PTP / <span class="glossary-term" data-glossary-id="s-plane" data-glossary-term="S-plane" data-glossary-definition="Synchronization plane — PTP/IEEE-1588 timing lock between O-DU and RU; prerequisite before C-plane and U-plane traffic." tabindex="0" role="button">S-plane</span> | ~100 ns–1 μs | C or Rust (linuxptp) |
...
S-plane (linuxptp or relaxed OSC timing), <span class="glossary-term" data-glossary-id="m-plane" data-glossary-term="M-plane" data-glossary-definition="Management plane — NETCONF/YANG configuration and capability exchange between O-DU and RU during initialization." tabindex="0" role="button">M-plane</span> NETCONF stub, <span class="glossary-term" data-glossary-id="c-plane" data-glossary-term="C-Plane" data-glossary-definition="The control plane handles planning and instructions but does not carry actual user data. It contains commands for how the user and their data should be handled, receives real-time scheduling instructions (beamforming weights, PRB allocations) from the DU, and tells the RU what UE data to modulate or demodulate." tabindex="0" role="button">C-plane</span>
...
|---|---|
| [`sa_signaling_storm.md`](sa_signaling_storm.md) Layer B | Closest to Phase 1 <span class="glossary-term" data-glossary-id="ue" data-glossary-term="UE" data-glossary-definition="User Equipment — the mobile device (phone/modem) that attaches to the cellular network." tabindex="0" role="button">UE</span> emulator (PHY-abstract NGAP scale) |
